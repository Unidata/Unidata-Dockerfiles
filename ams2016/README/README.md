...
<li><a href="#orgheadline3">3. Long Form Instructions</a></li>
<li><a href="#orgheadline12">4. Preliminary Setup on Azure</a>
<ul>
<li><a href="#orgheadline4">4.1. Install <code>docker-machine</code></a></li>
<li><a href="#orgheadline5">4.2. Create a VM on Azure</a></li>
<li><a href="#orgheadline6">4.3. Configure Unix Shell to Interact with New Azure VM</a></li>
<li><a href="#orgheadline7">4.4. Restart Azure VM</a></li>
<li><a href="#orgheadline8">4.5. <code>ssh</code> into VM with <code>docker-machine</code></a></li>
<li><a href="#orgheadline9">4.6. Install Packages with <code>apt-get</code></a></li>
<li><a href="#orgheadline10">4.7. Add <code>ubuntu</code> User to <code>docker</code> Group and Restart Docker</a></li>
<li><a href="#orgheadline11">4.8. Install <code>docker-compose</code> on VM</a></li>
</ul>
</li>
<li><a href="#orgheadline28">5. LDM and TDS Configuration</a>
<ul>
<li><a href="#orgheadline15">5.1. Background</a>
<ul>
<li><a href="#orgheadline13">5.1.1. <code>Unidata-Dockerfiles</code> Repository</a></li>
<li><a href="#orgheadline14">5.1.2. <code>TDSConfig</code> Repository</a></li>
</ul>
</li>
<li><a href="#orgheadline16">5.2. <code>git clone</code> Repositories</a></li>
<li><a href="#orgheadline25">5.3. Configuring the LDM</a>
<ul>
<li><a href="#orgheadline17">5.3.1. LDM Directories on Docker Host</a></li>
<li><a href="#orgheadline23">5.3.2. LDM Configuration Files</a></li>
<li><a href="#orgheadline24">5.3.3. Upstream Data Feed from Unidata or Elsewhere</a></li>
</ul>
</li>
<li><a href="#orgheadline27">5.4. Configuring the TDS</a>
<ul>
<li><a href="#orgheadline26">5.4.1. Edit TDS <code>catalog.xml</code> Files</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#orgheadline31">6. Setting up Data Volumes</a>
<ul>
<li><a href="#orgheadline29">6.1. Check Free Disk Space</a></li>
<li><a href="#orgheadline30">6.2. Create <code>/data</code> Directory</a></li>
</ul>
</li>
<li><a href="#orgheadline34">7. Opening Ports</a>
<ul>
<li><a href="#orgheadline32">7.1. More About the TDM</a></li>
<li><a href="#orgheadline33">7.2. Note about port ADDE 112</a></li>
</ul>
</li>
<li><a href="#orgheadline35">8. Tomcat Logging for TDS and RAMADDA</a></li>
<li><a href="#orgheadline41">9. Starting the LDM TDS RAMADDA TDM</a>
<ul>
<li>
<ul>
<li><a href="#orgheadline36">9.0.1. RAMADDA Preconfiguration</a></li>
<li><a href="#orgheadline37">9.0.2. Final Edit to <code>docker-compose.yml</code></a></li>
<li><a href="#orgheadline38">9.0.3. <code>chown</code> for Good Measure</a></li>
<li><a href="#orgheadline39">9.0.4. Pull Down Images from the DockerHub Registry</a></li>
<li><a href="#orgheadline40">9.0.5. Start the LDM, TDS, TDM, RAMADDA</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#orgheadline51">10. Check What is Running</a>
<ul>
<li><a href="#orgheadline42">10.1. Docker Process Status</a></li>
<li><a href="#orgheadline43">10.2. Checking Data Directory</a></li>
<li><a href="#orgheadline44">10.3. TDS and RAMADDA URLs</a></li>
<li><a href="#orgheadline50">10.4. Viewing Data with the IDV</a>
<ul>
<li><a href="#orgheadline45">10.4.1. Access TDS with the IDV</a></li>
<li><a href="#orgheadline49">10.4.2. Access RAMADDAA with the IDV</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#orgheadline57">11. Appendix</a>
<ul>
<li><a href="#orgheadline56">11.1. Common Problems</a>
<ul>
<li><a href="#orgheadline52">11.1.1. Certificate Regeneration</a></li>
<li><a href="#orgheadline53">11.1.2. Size of VM is not Large Enough</a></li>
<li><a href="#orgheadline54">11.1.3. Where is my Data and the Finicky TDM</a></li>
<li><a href="#orgheadline55">11.1.4. Cannot connect to the Docker daemon</a></li>
</ul>
</li>
</ul>
</li>
...
# Long Form Instructions<a id="orgheadline3"></a>

If you are opting for the long form instructions instead of the quick start, begin here.

# Preliminary Setup on Azure<a id="orgheadline12"></a>
...
## Install `docker-machine`<a id="orgheadline4"></a>
...
## <a id="orgtarget1"></a>Create a VM on Azure<a id="orgheadline5"></a>
...
## Configure Unix Shell to Interact with New Azure VM<a id="orgheadline6"></a>
...
## Restart Azure VM<a id="orgheadline7"></a>
...
## `ssh` into VM with `docker-machine`<a id="orgheadline8"></a>

    docker-machine ssh $AZURE_HOST

## Install Packages with `apt-get`<a id="orgheadline9"></a>
...
## <a id="orgtarget6"></a>Add `ubuntu` User to `docker` Group and Restart Docker<a id="orgheadline10"></a>
...
## Install `docker-compose` on VM<a id="orgheadline11"></a>
...
# LDM and TDS Configuration<a id="orgheadline28"></a>

## Background<a id="orgheadline15"></a>
...
### `Unidata-Dockerfiles` Repository<a id="orgheadline13"></a>
...
### `TDSConfig` Repository<a id="orgheadline14"></a>
...
## `git clone` Repositories<a id="orgheadline16"></a>
...
## Configuring the LDM<a id="orgheadline25"></a>

### LDM Directories on Docker Host<a id="orgheadline17"></a>
...
### LDM Configuration Files<a id="orgheadline23"></a>
...
### Upstream Data Feed from Unidata or Elsewhere<a id="orgheadline24"></a>
...
## Configuring the TDS<a id="orgheadline27"></a>

### Edit TDS `catalog.xml` Files<a id="orgheadline26"></a>
...
# Setting up Data Volumes<a id="orgheadline31"></a>
...
## Check Free Disk Space<a id="orgheadline29"></a>
...
## Create `/data` Directory<a id="orgheadline30"></a>
...
# Opening Ports<a id="orgheadline34"></a>
...
## More About the TDM<a id="orgheadline32"></a>
...
## Note about port ADDE 112<a id="orgheadline33"></a>

The ADDE port `112` is for future use since we have not dockerized ADDE, yet.

# Tomcat Logging for TDS and RAMADDA<a id="orgheadline35"></a>
...
# Starting the LDM TDS RAMADDA TDM<a id="orgheadline41"></a>

### RAMADDA Preconfiguration<a id="orgheadline36"></a>
...
### <a id="orgtarget3"></a>Final Edit to `docker-compose.yml`<a id="orgheadline37"></a>
...
### `chown` for Good Measure<a id="orgheadline38"></a>
...
### Pull Down Images from the DockerHub Registry<a id="orgheadline39"></a>
...
### Start the LDM, TDS, TDM, RAMADDA<a id="orgheadline40"></a>
...
# <a id="orgtarget4"></a>Check What is Running<a id="orgheadline51"></a>
...
## Docker Process Status<a id="orgheadline42"></a>
...
## Checking Data Directory<a id="orgheadline43"></a>
...
## TDS and RAMADDA URLs<a id="orgheadline44"></a>
...
### Access RAMADDAA with the IDV<a id="orgheadline49"></a>
...
# Appendix<a id="orgheadline57"></a>

## Common Problems<a id="orgheadline56"></a>

### <a id="orgtarget5"></a>Certificate Regeneration<a id="orgheadline52"></a>
...
### Size of VM is not Large Enough<a id="orgheadline53"></a>
...
### <a id="orgtarget8"></a>Where is my Data and the Finicky TDM<a id="orgheadline54"></a>
...
### Cannot connect to the Docker daemon<a id="orgheadline55"></a>
